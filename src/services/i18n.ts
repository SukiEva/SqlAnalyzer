...
const messages = {
  en: {
    ...
    runner: {
      ...
      shortcutPlain: "Ctrl+Enter",
      shortcutAnalyze: "Ctrl+Shift+Enter",
      shortcutPerformance: "Ctrl+Alt+Enter",
  ...
  zh: {
    ...
    runner: {
      ...
      shortcutPlain: "Ctrl+回车",
      shortcutAnalyze: "Ctrl+Shift+回车",
      shortcutPerformance: "Ctrl+Alt+回车",
